...
class ManuscriptPalimpsestTranslation extends Model
{
    protected $table = "ms_manuscript_palimpsest_text_translations";
...
//    protected $fillable = ["language_id", "translator_id", "entry"];
    ...
    public $editLarge = array(
        "palimpsest_text_translation",
        "palimpsest_text_translation_reference"
    );
