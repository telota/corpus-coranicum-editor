...
class ManuscriptSajdaSignsTranslation extends Model
{
    protected $table = "ms_manuscript_sajda_signs_text_translations";
...
//    protected $fillable = ["language_id", "translator_id", "entry"];
    ...
    public $editLarge = array(
        "sajda_signs_text_translation",
        "sajda_signs_text_translation_reference"
    );
