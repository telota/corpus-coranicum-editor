...
class CompareLesartenCanonicBySura extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'compare:lesarten:canon:sura';
    ...
    public function handle()
    {
        ...
        for ($sure = 1; $sure <= 114; $sure++)
        {
            ...
            $output = $outputDir . "leser_similarities_canon_sure_" . str_pad($sure, 3, 0, STR_PAD_LEFT) . "_" . Carbon::now("Europe/Berlin")->now()->format("Ymd_his") . ".csv";
            ...
            foreach(Koranstelle::getAllWordsBySura($sure) as $koranstelle)
            {
                ...
                if ($i % 250 == 0) {
                    ...
                    echo "Sure " . $sure . ": Processing " . $i . " of " . $numWords . "\n";
