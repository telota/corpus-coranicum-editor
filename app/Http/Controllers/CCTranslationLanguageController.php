...
class CCTranslationLanguageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("cc_translation_languages.index", compact([
            "languages"
        ]));
    }
    ...
    public function create()
    {
        ...
        $columns = Schema::getColumnListing('cc_translation_languages');

        $action = array('App\Http\Controllers\CCTranslationLanguageController@store');
        ...
        return view("cc_translation_languages.create", compact([
            "language",
            "action"
        ]));
    }
    ...
    public function store(Request $request)
    {
        ...
        return view("cc_translation_languages.show", compact("language"));
    }
    ...
    public function edit($id)
    {
        ...
        $action = array('App\Http\Controllers\CCTranslationLanguageController@update', $id);


        return view("cc_translation_languages.edit", compact([
            "language",
            "action"
        ]));
    }
