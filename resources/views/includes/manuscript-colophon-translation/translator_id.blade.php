<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <span href="#" data-toggle="tooltip" title="Author role: manuscript - translation">
    ...
    <div class="panel-body space-between">
        <?php
        $translators = \App\Models\GeneralCC\CCAuthor::getAuthorsArraySelect('manuscript', 'translation');
        ?>
        <div>
