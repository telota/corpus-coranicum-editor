...
@section("title")
    <h1>
        Original Languages
        <a href="{{ URL::action([App\Http\Controllers\IntertextOriginalLanguageController::class, 'create']) }}">
    ...
    <tbody>
        @foreach($languages as $language)
            <tr>
                <td>{{ $language->id }}</td>
                <td>
                    <a href="{{ URL::action([App\Http\Controllers\IntertextOriginalLanguageController::class, 'show'], $language->id) }}">
