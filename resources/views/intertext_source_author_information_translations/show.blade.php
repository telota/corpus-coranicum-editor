...
<?php $sourceAuthor = $infoTranslation->sourceAuthor;?>

@section("title")
    <h1>
        {{ ucfirst($infoTranslation->language->translation_language) . " Source CCAuthor Information Text - "    }}
        <a href="{{ URL::action([IntertextSourceAuthorController::class, 'show'], $sourceAuthor->id) }}">
           {{ $sourceAuthor->author_name  }}
        </a>
        <a href="{{ URL::action([IntertextSourceAuthorInformationTranslationController::class, 'edit'], $infoTranslation->id) }}">
...
@section("content")
    ...
    <ul class="list-group">
        <li class="list-group-item">
            <span class="label label-default">Source Author ID</span>
            {!! $infoTranslation->source_author_id !!}
        </li>
        <li class="list-group-item">
